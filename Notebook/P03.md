# P03 - QIIME 2 Taxonomic Analysis and Taxonomy-based filtering
...
2. /data/team6_dysautonomia_datateam6_dysautonomia_taxonomy.qzv - [file](/QIIME2/Data_processing/export/taxonomy.qzv)
3. /data/team6_dysautonomia_datateam6_dysautonomia_taxa-bar-plots.qzv - [file](/QIIME2/Data_processing/export/taxa-bar-plots.qzv)
4. /data/team6_dysautonomia_datateam6_dysautonomia_table-no-mitochondria-no-chloroplast.qza
5. /data/team6_dysautonomia_datateam6_dysautonomia_table-no-mitochondria-no-chloroplast.qzv - [file](/QIIME2/Data_processing/export/table-no-mitochondria-no-chloroplast.qzv)
...
> <img src="/QIIME2/Data_processing/figures/taxonomic_bar_plot_level_7.png" height="300">

Table summary and frequency per sample after filtering mitochondria and chloroplast
> <img src="/QIIME2/Data_processing/figures/table-no-mitochondria-no-chloroplast.png" height="450">
