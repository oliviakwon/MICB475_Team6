...
## Material: 
1. Phyloseq object (ASV matrix and metadata)
...
## Future direction:
Choose a variable that significantly contributes to gut microbiome dysbiosis in mice and examine the microbial taxa and diversity. 
