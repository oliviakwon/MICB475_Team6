...
2. Melt the metric dataset
3. Plot ggplot (x = age, y = metric)
4. Run Kruskal-wallis tests on different metrics to determine significance (code retrieved from [https://raunakms.github.io/diversity_cooking_fuel/06_01_permanova_test.html](https://raunakms.github.io/diversity_cooking_fuel/06_01_permanova_test.html))
