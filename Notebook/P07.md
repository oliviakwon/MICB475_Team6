...
### Codes:
[Aim2 - age](/R_Project/Aim2/Aim2_age.R)
...
### Codes
[Aim2 - other variables](/R_Project/Aim2/Aim2_other_beta.R)
...
### Codes:
[Aim2 - sex](/R_Project/Aim2/Aim2_sex.R)
...
### Codes
* [Aim2 - sex alpha](/R_Project/Aim2/Aim2_sex_alpha_glm.R)
* [Aim2 - sex beta](/R_Project/Aim2/Aim2_sex_beta_marginal.R)
...
* the codes for relative abundance is linked to [Alpha_diversity](/Scripts_final/Alpha_diversity.R) and [Beta_diveristy](/Scripts_final/Beta_diversity.R) for final manuscript use
...
### Codes:
* [Aim2 - taxa barplot](/R_Project/Aim2/Aim2_sex_taxa_final.R)
...
* the codes for relative abundance is linked to [Relative_abundance](/Scripts_final/Relative_abundance.R) for final manuscript use
