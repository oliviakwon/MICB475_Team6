...
> <img width="502" alt="Aim2 bray age adonis" src="https://github.com/oliviakwon/MICB475_Team6/assets/158625508/c78c34df-7bbf-4ccc-a2ae-6142a4cc60c7" height="200">
Permanova - Jaccard
> <img width="526" alt="Aim2 jaccard age adonis" src="https://github.com/oliviakwon/MICB475_Team6/assets/158625508/00e45e87-c925-47ec-9682-a06abaae0410" height="200">
...
5. Plot the metric ordination (color = age)
6. Perform Permanova on each metric (dist.metric ~ Age,data=data)
7. Perform post-hoc test for PERMANOVA with bonferroni method.

### Results: 

#### Alpha diversity 
Kurskal-Wallis rank sum test - shannon
> <img src="/R_Project/Aim2/aim2_age_shannon_kw.png" height="300">
Kurskal-Wallis rank sum test - chao1
> <img src="/R_Project/Aim2/aim2_age_chao1_kw.png" height="300">
Kurskal-Wallis rank sum test - pielou's evenness
> <img src="/R_Project/Aim2/aim2_age_pielou_kw.png" height="300">
Kurskal-Wallis rank sum test - faith's phylogenetic diversity
> <img src="/R_Project/Aim2/aim2_age_pd_kw.png" height="300">
Boxplot - shannon
> <img src="/R_Project/Aim2/aim2_age_shannon.png" height="300">
Boxplot - chao1
> <img src="/R_Project/Aim2/aim2_age_chao1.png" height="300">
...
Permanova - unifrac
> <img src="/R_Project/Aim2/aim2_age_unifrac_perm.png" height="300">
Permanova - unweighted unifrac
> <img src="/R_Project/Aim2/aim2_age_wunifrac_perm.png" height="300">
Post-hoc - bray
> <img src="/R_Project/Aim2/aim2_age_bray_posthoc.png" height="300">
Post-hoc - jaccard
> <img src="/R_Project/Aim2/aim2_age_jaccard_posthoc.png" height="300">
Post-hoc - unweighted unifrac
> <img src="/R_Project/Aim2/aim2_age_unifrac_posthoc.png" height="300">
Post-hoc - weighted unifrac
> <img src="/R_Project/Aim2/aim2_age_wunifrac_posthoc.png" height="300">
