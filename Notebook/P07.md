...
### Codes:
* alpha diversity: [Aim2_age_alpha_v1](/R_Project/Aim2/Aim2_age_alpha_v1.txt)
...
* the codes for relative abundance is linked to [Alpha_diversity](/MICB475_Team6/Analyses/Alpha_diversity.txt) and [Beta_diveristy](/MICB475_Team6/Analyses/Beta_diveristy.txt) for final manuscript use
...
* the codes for relative abundance is linked to [Relative_abundance](/MICB475_Team6/Analyses/Relative_abundance.txt) for final manuscript use
