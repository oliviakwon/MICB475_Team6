...
### Code
* PICRUSt2 analysis using qiime2-picrust2 plugin: [qiime2-picrust2](/QIIME2/PICRUSt2/PICRUSt2_code.txt)
...
* Relevant codes are prepared manuscript use: [PICRUSt Analysis](/Scripts_final/PICRUSt_R.R) and [Correlation Experiment Analysis](/Scripts_final/Correlation.R)
