...
### Purpose:
To perform a functional analysis to predict what metabolic pathways are enriched or depleted in relation to the significant variable(s) linked to gut microbiome dysbiosis identified in aim 1. Perform correlation analysis between taxa composition from aim 2 and metabolic pathways. 
