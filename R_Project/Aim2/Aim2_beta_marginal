#done:
#export picture of aim2.sex.bray.marginal.p, aim2.sex.uw.p, and aim2.sex.jaccard.p -> put into figure slide


# for Karen (also check the figure slides)
aim2.sex.uw.p - only need to figure out the permanova test #done
aim2.age.bray.marginal.p -> need to figure out the stats and also post hoc and p adjust #done; not sure about the figures
...
#if want to perform wilcox, we can +1 to all the values
...
#plot ordination
sex.uw.ord.p = plot_ordination(FD_phyloseq_subset, #change this
                                    sex.wu.ord, #change this
                                    color = "Sex") #change this to the sex category
#title = "Bray-Curtis dissimilarity across mouse sexes") #change this
# Load 'ggside' package
library(ggside)
